                              ...
                              <div className="row">
                                       ...
                                       <Col lg="4">
                                          <Form.Group className=" form-group mb-4">
                                             <Form.Check className=" form-check-inline">
                                                ...
                                                <Form.Control.Feedback type="invalid">{errors.hasPo?.message}</Form.Control.Feedback>
                                             </Form.Check>
                                          </Form.Group>
                                       </Col>
                                       <Col lg="4">
                                 ...
                                 <Col lg="6">
                                    <Row>
                                       ...
                                       <Col lg="3">
                                          <Form.Label htmlFor="dueDate">&nbsp;</Form.Label>
                                          <Form.Floating className="custom-form-floating custom-form-floating-sm form-group mb-4">
