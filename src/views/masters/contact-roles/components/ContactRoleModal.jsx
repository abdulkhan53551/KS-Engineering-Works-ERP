...
import { contactRoleValidationSchema } from '../../../../validation/master.validation';
import { useCreateContactRole, useUpdateContactRole } from '../../hooks/useMastersApi';

/**
 * ContactRoleModal Component
 * Add / Edit / View modal for Contact Roles Master
 */
const ContactRoleModal = ({ show, onHide, mode = 'create', initialData = null }) => {
    ...
    const {
        ...
        resolver: joiResolver(contactRoleValidationSchema),
        defaultValues: {
            roleCode: '',
            roleName: '',
            description: ''
    ...
    const { mutate: createRole, isPending: isCreating } = useCreateContactRole();
    const { mutate: updateRole, isPending: isUpdating } = useUpdateContactRole();
                        ...
                        <Col md={12}>
                            <Form.Floating className="custom-form-floating custom-form-floating-sm form-group mb-2">
                                <Form.Control
                                    type="text"
                                    id="roleCode"
                                    placeholder="Role Code (e.g. OWNER)"
                            ...
                            <span className="text-muted d-block" style={{ fontSize: '0.72rem', marginTop: '-4px' }}>
                                e.g., OWNER, MANAGER, PURCHASE_HEAD, ACCOUNTANT
                            </span>
                        </Col>
                        ...
                        <Col md={12}>
                            <Form.Floating className="custom-form-floating custom-form-floating-sm form-group mb-2">
                                <Form.Control
                                    type="text"
                                    id="roleName"
                                    placeholder="Role Name (e.g. Business Owner)"
